   ...
   render() {
      ...
      return (
         <div className={classNames} style={style}>
            {children}
            {status != 'error' && (
               <div class={CSS.expand(CSS.element(baseClass, 'loading', { loading: loading }))}>
                  {Icon.render(data.loadingIcon, { className: CSS.element(baseClass, 'loading-icon') })}
                  ...
                  <div>
                     ...
                     <div className={CSS.element(baseClass, 'buttons')}>
                        ...
                        {instance.widget.onRetry && (
                           <button
                              className={CSS.expand(CSS.block('button'), CSS.mod('primary'), 'ml-2')}
                              onClick={(e) => {
                                 instance.set('status', 'ok');
