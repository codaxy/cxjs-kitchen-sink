    ...
    return (
      <div className={classNames} style={style}>
        ...
        {status != 'error' &&
          <div
            class={CSS.expand (
              CSS.element (baseClass, 'loading', {loading: loading})
            )}
          >
        ...
        {status == 'error' &&
          <div className={CSS.element (baseClass, 'error')}>
            <div>
              <div className={CSS.element (baseClass, 'error-title')}>
                {errorTitle}
              </div>
              <div className={CSS.element (baseClass, 'error-message')}>
                {errorMessage}
              </div>
...
export class LoadingSignal extends Widget {
  ...
  explore (context, instance) {
    if (instance.data.loading && isFunction (context.setLoading))
      context.setLoading ();
  }
